...
from ssh_security_application.config import LoggingConfig
from ssh_security_application.models import AuditRecord
...
class AuditService:
    ...
    def __init__(self, repository: AuditRepository) -> None:
        ...
        self.logger = logging.getLogger("ssh_security_application.audit")
