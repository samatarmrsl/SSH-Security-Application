...
from ssh_guard.models import HealthStatus, NetworkEvent
...
class NetworkTcpdumpCollector:
    ...
    def __init__(
        ...
        *,
        ...
        self.logger = logging.getLogger("ssh_guard.collectors.network_tcpdump")
    ...
    def start_follow(self) -> threading.Thread:
        ...
        self._thread = threading.Thread(
            target=self.follow,
            name="ssh-guard-network-tcpdump",
            daemon=True,
        )
        self._thread.start()
        return self._thread
