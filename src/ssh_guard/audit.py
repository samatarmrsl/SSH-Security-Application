...
from ssh_guard.config import LoggingConfig
from ssh_guard.db.repositories import AuditRepository
from ssh_guard.models import AuditRecord
...
class AuditService:
    ...
    def __init__(self, repository: AuditRepository) -> None:
        ...
        self.logger = logging.getLogger("ssh_guard.audit")
